                ...
                (function () {
                    ...
                    (function () {
                        ...
                        modules[namespace] = function () {
                            ...
                            (internalModule.s = internalModule.s || []).push([
                                promiseResponseId,
                                promiseFunctionId,
                                theArguments
                            ]);
                            ...
                            promiseFunction.then = function (fulfillmentHandler, errorHandler, progressHandler) {
                                ...
                                var fulfillmentHandlers = (internalModule.fh[promiseResponseId] =
                                        internalModule.fh[promiseResponseId] || []),
                                    errorHandlers = (internalModule.eh[promiseResponseId] =
                                        internalModule.eh[promiseResponseId] || []),
                                    progressHandlers = (internalModule.ph[promiseResponseId] =
                                        internalModule.ph[promiseResponseId] || []);
                        ...
                        internalModule.l = url
                            ? url.replace(/^\/\//, (protocol == 'https:' ? protocol : 'http:') + '//')
                            : url;
                        ...
                        theWindow.addEventListener
                            ? theWindow.addEventListener(load, windowLoadHandler, false)
                            : theWindow.attachEvent('on' + load, windowLoadHandler);
                        ...
                        var downloadIntoFrameContext = function () {
                            ...
                            documentBody.insertBefore(innerFrameWrapper, documentBody.firstChild).id =
                                lightningjsName + '-' + namespace;
                            ...
                            try {
                                ...
                                innerFrame[srcAttr] =
                                    domainSrc +
                                    'd.write("' +
                                    buildInnerFrameHtml().replace(/"/g, String.fromCharCode(92) + '"') +
                                    '");d.close();';
                            }
