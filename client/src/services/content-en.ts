...
const content = {
    ...
    home: {
        ...
        intro: `Yivi is an app you can use to prove who you are when online. Yivi offers a new way of logging in, and is different to other familiar methods like DigiD. When you've reported public nuisance in Amsterdam, you can [check your reports via Yivi (in Dutch)](https://www.amsterdam.nl/veelgevraagd/?caseid=%7Bfbeab9ad-81e4-4fee-9dfc-3fd62eb92719%7D).

Below you will find various demos that you can use to find out how Yivi works. Use your own details to see the demos. The City of Amsterdam will not store this data.
        `,
        requirements: {
